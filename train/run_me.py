...
# pnet
params_file_list.append('./ClinMultiDLBCL/onsplit_average_reg_10_tanh_large_testing')
# params_file_list.append('./ClinMultiDLBCL/crossvalidation_average_reg_10_tanh')
if __name__ == '__main__':
    for params_file in params_file_list:
        ...
        spec = importlib.util.spec_from_file_location(params_file, params_file_full)
